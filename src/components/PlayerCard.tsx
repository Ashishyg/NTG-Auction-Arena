...
export function PlayerCard({
  ...
  return (
    <div className={`overflow-hidden rounded-[1.5rem] border bg-white/[0.045] shadow-[0_20px_50px_-24px_rgba(0,0,0,0.7)] ${live ? "border-[var(--color-brand)]/40" : "border-white/[0.12]"}`}>
      <div className="p-6 sm:p-7">
        ...
        <dl className="mt-6 grid grid-cols-2 gap-3 sm:grid-cols-3">
          {fields.map((f) => (
            <div key={f.key} className="rounded-2xl border border-white/[0.1] bg-white/[0.04] px-3.5 py-2.5">
      ...
      <div className="border-t border-white/[0.1] bg-white/[0.03] px-6 py-3.5 sm:px-7">
        {highestBidderName ? (
